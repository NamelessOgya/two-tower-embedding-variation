# Plan 006: Strong Baseline 上での全多様性手法スイープおよび Pareto Frontier 統合評価
...
Plan 001〜004 では、未補正の言語モデル (mE5) によるテキスト埋め込みをベースライン（`M0_raw`）として各種多様性手法を評価していた。
...
強力な基盤モデルの上で、精度-多様性の真の Pareto 最適フロンティアを明らかにする。
...
### Sub-exp 6C: 3B Diversity Adapter $\lambda$ スイープ on `M0_strong`
